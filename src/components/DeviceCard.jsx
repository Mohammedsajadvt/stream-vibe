...
function DeviceCard() {
    return (
        <div className='grid md:grid-cols-3   pt-10 gap-5'>
            {
                deviceData.map((data) => (
                    <div className='bg-gradient-to-tr sm:mt-2 cursor-pointer transition hover:-translate-y-1 ease-in-out delay-150 duration-300  from-[#0F0F0F] min-w-[350px] to-[#E50000]/15  via-[#1A1A1A] px-8 py-8  rounded-lg'>
